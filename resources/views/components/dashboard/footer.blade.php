<footer x-data="{ loadingShell: true }" x-init="setTimeout(() => { loadingShell = false }, 600)" class="mt-12 border-t border-slate-200/80 bg-white/95">
    ...
    <div x-show="!loadingShell" x-cloak class="mx-auto w-full max-w-6xl px-5 py-8 sm:px-6 lg:px-8">
        <div class="grid gap-8 md:grid-cols-3">
            ...
            <div class="grid grid-cols-2 gap-6 text-sm text-slate-600">
                <div class="space-y-2">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="{{ route('student.dashboard') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-home-5-line text-base" aria-hidden="true"></i>
                                <span>Dashboard</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('student.announcements.index') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-megaphone-line text-base" aria-hidden="true"></i>
                                <span>Announcements</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('student.events.index') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-calendar-event-line text-base" aria-hidden="true"></i>
                                <span>Events</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('student.resources.index') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                ...
                <div class="space-y-2">
                    ...
                    <ul class="space-y-2">
                        <li>
                            <a href="mailto:acsesrepos@gmail.com" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-mail-line text-base" aria-hidden="true"></i>
                                <span>Email support</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('student.suggestions.index') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-feedback-line text-base" aria-hidden="true"></i>
                                <span>Suggestion box</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('marketing.developers') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-team-line text-base" aria-hidden="true"></i>
                                <span>Meet the developers</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('legal.privacy') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
                                <i class="ri-shield-keyhole-line text-base" aria-hidden="true"></i>
                                <span>Privacy policy</span>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('legal.terms') }}" class="inline-flex items-center gap-3 transition hover:text-[#0b3019]">
            ...
            <div class="space-y-3 text-sm text-slate-600">
                ...
                <p>Reach the ACSES academic services team for questions about registrations, dues, or academic resources.</p>
                <div class="rounded-2xl border border-slate-200 bg-white/70 p-4">
                    <div class="space-y-2">
                        <div class="flex items-center justify-between text-sm">
                           
                            <a href="tel:+233559359824" class="inline-flex items-center gap-2 text-[#0b3019] hover:underline">
                                <i class="ri-customer-service-2-line text-base" aria-hidden="true"></i>
                                055 935 9824
                            </a>
                        </div>
                        <p class="text-xs text-slate-500">Weekdays · 08:00–20:00 GMT</p>
                        <div class="flex items-center justify-between text-sm pt-2">
                            
                            <a href="mailto:acsesrepos@gmail.com" class="inline-flex items-center gap-2 text-[#0b3019] hover:underline">
                                <i class="ri-mail-send-line text-base" aria-hidden="true"></i>
                                acsesrepos@gmail.com
                            </a>
                        </div>
                        <p class="text-xs text-slate-500">We reply within one business day.</p>
                    </div>
                </div>
                <a href="{{ route('student.suggestions.index') }}" class="inline-flex items-center justify-center gap-2 rounded-xl border border-[#0b3019]/20 bg-[#0b3019]/5 px-4 py-2 text-sm font-semibold text-[#0b3019] transition hover:-translate-y-0.5 hover:border-[#0b3019]/40">
        ...
        <div class="mt-8 flex flex-col items-center justify-between gap-3 border-t border-slate-200 pt-4 text-xs text-slate-500 sm:flex-row">
            ...
            <div class="flex items-center gap-4">
                <a href="{{ route('legal.privacy') }}" class="inline-flex items-center gap-2 transition hover:text-[#0b3019]">
                    <i class="ri-lock-2-line text-base" aria-hidden="true"></i>
                    Privacy policy
                </a>
                <a href="{{ route('legal.terms') }}" class="inline-flex items-center gap-2 transition hover:text-[#0b3019]">
                    <i class="ri-article-line text-base" aria-hidden="true"></i>
                    Terms of service
                </a>
                <a href="{{ route('legal.cookies') }}" class="inline-flex items-center gap-2 transition hover:text-[#0b3019]">
