                ...
                <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width:560px; background-color:#ffffff; border-radius:20px; overflow:hidden; box-shadow:0 14px 40px rgba(11,48,25,0.12);">
                    <tr>
                        <td style="background:linear-gradient(135deg, {{ $brandColor }}, #145132); padding:32px 24px; text-align:center;">
                            <p style="margin:0; font-size:12px; letter-spacing:0.35em; color:#a0f5cb; text-transform:uppercase;">ACSES Registration</p>
                            <h1 style="margin:12px 0 0; font-size:24px; font-weight:600; color:#ffffff;">Verify Your Email</h1>
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    <td style="padding:0;">
                                        ...
                                        <table role="presentation" cellpadding="0" cellspacing="0" style="width:100%;">
                                            ...
                                            <tr>
                                                <td style="padding:6px 0; font-size:13px; color:#6b7280;">Year:</td>
                                                <td style="padding:6px 0; font-size:13px; color:#1f2937; font-weight:500;">Year {{ $registration->year }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
