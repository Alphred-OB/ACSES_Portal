            ...
            <div class="space-y-2">
                ...
                <div class="relative">
                    ...
                    <input id="email" name="email" type="email" required autocomplete="email" value="{{ old('email') }}"
                        class="block w-full rounded-xl border border-slate-300 bg-white py-3 pl-11 pr-3 text-sm text-slate-900 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30"
