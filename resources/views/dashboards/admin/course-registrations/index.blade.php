    ...
    <div x-data="{ loading: true }" x-init="setTimeout(() => { loading = false }, 600)" class="relative">
        <div x-show="loading" x-transition.opacity.duration.200ms class="pointer-events-none absolute inset-0 z-10 flex justify-center bg-slate-50/80 backdrop-blur-sm">
            <div class="mx-auto flex w-full max-w-6xl flex-col gap-6 px-5 py-10 sm:px-6 lg:px-8">
                ...
                <section class="space-y-6 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-lg shadow-[#0b3019]/8">
        ...
        <header class="flex flex-col gap-4 rounded-3xl border border-[#0b3019]/15 bg-white/80 p-6 shadow-lg shadow-[#0b3019]/5 sm:flex-row sm:items-center sm:justify-between">
            <div class="space-y-2">
                ...
                <h1 class="text-2xl font-semibold text-[#0b3019] sm:text-3xl">Review student submissions</h1>
        ...
        <section class="space-y-6 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-lg shadow-[#0b3019]/5">
            <form method="GET" class="space-y-3 rounded-2xl border border-slate-200/80 bg-slate-50/70 p-4 md:flex md:flex-wrap md:items-end md:gap-3 md:space-y-0">
                ...
                <div class="flex w-full flex-col gap-2 md:w-64">
                    ...
                    <div class="relative">
                        ...
                        <input id="filter_search" type="search" name="search" value="{{ $search }}" placeholder="Name, email, class" class="h-11 w-full rounded-2xl border border-slate-200 bg-white pl-11 pr-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30" />
                    </div>
                </div>
                    ...
                    <div class="flex flex-col gap-3 md:flex-row md:items-center md:gap-4" x-show="selectedIds.length" x-cloak x-transition.opacity>
                        <div class="flex flex-col gap-2 md:flex-row md:items-center md:gap-3">
                            <div class="flex flex-col gap-1">
                                ...
                                <select id="bulk_status" x-model="statusValue" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-[#0b3019] focus:ring-[#0b3019]/60 md:min-w-[12rem]">
                            ...
                            <div x-show="statusValue === 'rejected'" class="flex flex-1 flex-col gap-1 md:w-64" x-transition>
                                ...
                                <textarea id="bulk_comment" rows="2" x-model="commentValue" class="w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm text-slate-700 focus:border-[#0b3019] focus:ring-[#0b3019]/60" placeholder="Let students know what to fix"></textarea>
                            </div>
                        </div>
                        <div class="flex flex-col gap-2 md:flex-row md:items-center md:gap-3">
                            <button type="button" class="inline-flex items-center gap-2 rounded-lg bg-[#0b3019] px-4 py-2 text-sm font-medium text-white transition hover:bg-[#0b3019]/90 disabled:opacity-60" @click="submit('update_status')" :disabled="!canApplyStatus">
                                <i class="ri-check-double-line text-sm" aria-hidden="true"></i>
                                Apply status
                            </button>
                            <button type="button" class="inline-flex items-center gap-2 rounded-lg border border-[#0b3019]/40 px-4 py-2 text-sm font-medium text-[#0b3019] transition hover:bg-[#0b3019]/10 disabled:opacity-60" @click="submit('download_documents')" :disabled="!selectedIds.length">
                                ...
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-right">
                                        @if (!empty($registration->document_paths))
                                            <a href="{{ route('admin.course-registrations.show', $registration) }}" class="inline-flex items-center gap-2 rounded-xl border border-slate-200 px-3 py-1.5 text-xs font-semibold text-slate-600 transition hover:border-[#0b3019]/40 hover:text-[#0b3019]">
