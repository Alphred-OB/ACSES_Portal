    ...
    <div class="mx-auto w-full max-w-4xl space-y-8 px-5 py-10 sm:px-6 lg:px-8">
        <header class="flex flex-col gap-3 rounded-3xl border border-[#0b3019]/15 bg-white/90 p-6 text-center shadow-lg shadow-[#0b3019]/10 sm:text-left md:flex-row md:items-center md:justify-between">
            <div class="space-y-2">
                ...
                <h1 class="text-2xl font-semibold text-[#0b3019] md:text-3xl">Update resource</h1>
                ...
                <div class="grid gap-5 md:grid-cols-2">
                    <div class="space-y-3">
                        ...
                        <div class="grid gap-2 sm:grid-cols-3">
                            @foreach ($resourceTypes as $type)
                                <label class="inline-flex items-center gap-2 rounded-2xl border px-4 py-2 text-sm font-semibold transition" :class="resourceType === '{{ $type }}' ? 'border-[#0b3019] bg-[#0b3019]/10 text-[#0b3019]' : 'border-slate-200 text-slate-600 hover:border-[#0b3019]/40 hover:text-[#0b3019]'">
                    ...
                    <div class="md:col-span-2" x-show="resourceType === 'file'" x-cloak>
                        ...
                        @if ($resource->file_path)
                            <p class="text-xs text-slate-500">Current file: <span class="font-medium text-[#0b3019]">{{ basename($resource->file_path) }}</span></p>
                        @endif
                    </div>
                </div>
            </section>
