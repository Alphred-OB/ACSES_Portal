        ...
        <header class="space-y-3 rounded-3xl border border-[#0b3019]/15 bg-white p-6 shadow-lg shadow-[#0b3019]/10">
            <div class="flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                <div>
                    ...
                    <h1 class="mt-2 text-3xl font-semibold text-[#0b3019]">Revenue &amp; collection insights</h1>
                    <p class="text-sm text-slate-600">Track dues inflows, top-performing cohorts, and outstanding balances.</p>
                </div>
                <a href="{{ route('admin.dues.index', request()->query()) }}" class="inline-flex items-center justify-center gap-2 rounded-2xl border border-[#0b3019]/20 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#0b3019] shadow-sm transition hover:-translate-y-0.5 hover:bg-white/90">
        ...
        <section class="space-y-6 rounded-3xl border border-[#0b3019]/10 bg-white p-6 shadow-lg shadow-[#0b3019]/10">
            <form method="GET" class="grid gap-4 rounded-2xl border border-slate-200/70 bg-slate-50/70 p-4 md:grid-cols-5">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="academic_year" class="h-11 rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="status" class="h-11 rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="class" class="h-11 rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <select name="year" class="h-11 rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        <option value="">All years</option>
                ...
                <div class="flex items-end justify-end gap-3">
                    ...
                    <button type="submit" class="inline-flex items-center gap-2 rounded-2xl bg-[#0b3019] px-5 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-white shadow-lg shadow-[#0b3019]/20 transition hover:-translate-y-0.5 hover:bg-[#0b3019]/90">
            ...
            <div class="grid gap-4 md:grid-cols-2">
                <article class="space-y-4 rounded-3xl border border-[#0b3019]/15 bg-[#0b3019] p-6 text-white shadow-lg shadow-[#0b3019]/20">
            ...
            <div class="grid gap-4 md:grid-cols-3">
                <article class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                    ...
                    @if (data_get($stats, 'leaders.best_class'))
                        <p class="mt-3 text-xl font-semibold text-[#0b3019]">{{ data_get($stats, 'leaders.best_class.label') }}</p>
                ...
                <article class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                    ...
                    @if (data_get($stats, 'leaders.best_year'))
                        <p class="mt-3 text-xl font-semibold text-[#0b3019]">{{ data_get($stats, 'leaders.best_year.label') }}</p>
                ...
                <article class="rounded-2xl border border-slate-200/80 bg-white p-5 shadow-sm">
                    ...
                    @if (data_get($stats, 'leaders.best_class_year'))
                        <p class="mt-3 text-xl font-semibold text-[#0b3019]">{{ data_get($stats, 'leaders.best_class_year.label') }}</p>
            ...
            <div class="rounded-3xl border border-slate-200/80 bg-slate-50/80 p-6 text-sm text-slate-600">
                <p class="font-semibold text-[#0b3019]">Collection rate</p>
                <p class="mt-2 text-3xl font-semibold text-[#0b3019]">{{ number_format($collectionRate, 2) }}%</p>
                ...
                <div
                    ...
                    aria-hidden="true"
                >
                    <div class="h-full rounded-full bg-[#0b3019]" :style="{ width: (rate > 0 ? rate : 0) + '%' }"></div>
                </div>
