    ...
    <div class="mx-auto w-full max-w-4xl space-y-6 px-5 py-10 sm:px-6 lg:px-8">
        ...
        <header class="flex flex-col gap-3 sm:flex-row sm:items-start sm:justify-between animate-fade-slide">
            <div class="space-y-1">
                ...
                <h1 class="text-2xl font-bold tracking-tight text-slate-900">Create an event</h1>
                <p class="text-sm text-slate-500">Share upcoming activities with students and staff. All fields can be updated later.</p>
            </div>
