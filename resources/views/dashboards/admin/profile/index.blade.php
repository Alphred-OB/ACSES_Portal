...
<x-layouts.admin :title="$title">
    <div class="mx-auto w-full max-w-6xl space-y-10 px-5 py-10 sm:px-6 lg:px-8">
        <header class="space-y-4 rounded-[28px] border border-[#0b3019]/15 bg-gradient-to-br from-[#0b3019] via-[#124427] to-[#0b3019] p-8 text-white shadow-[0_24px_60px_-30px_rgba(11,48,25,0.45)]">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div class="space-y-2">
                    <p class="inline-flex items-center gap-2 rounded-full bg-white/15 px-4 py-1 text-xs font-semibold uppercase tracking-[0.3em] text-emerald-100/90">
                    ...
                    <p class="max-w-2xl text-sm text-emerald-100/85">Update personal details, invite additional administrators, and capture point-in-time system insights for audits.</p>
                </div>
                <div class="rounded-3xl border border-white/20 bg-white/10 px-6 py-4 text-sm text-emerald-50 shadow-inner">
                    <p class="font-semibold uppercase tracking-[0.25em] text-emerald-200">Signed in as</p>
                    <p class="mt-2 text-base font-semibold">{{ $admin->fullname ?? $admin->username }}</p>
                    <p class="text-xs text-emerald-100/80">{{ $admin->email }}</p>
                </div>
            </div>
        </header>
        ...
        @if (session('status'))
            <div class="flex items-start gap-3 rounded-3xl border border-emerald-200 bg-emerald-50 px-5 py-4 text-sm text-emerald-800 shadow-sm">
                <span class="mt-0.5 inline-flex h-8 w-8 items-center justify-center rounded-full bg-white text-[#0b3019]">
        ...
        <section class="grid gap-6 lg:grid-cols-2">
            <article class="rounded-[28px] border border-[#0b3019]/15 bg-white p-6 shadow-lg shadow-[#0b3019]/10">
                <header class="space-y-2">
                    <h2 class="flex items-center gap-3 text-xl font-semibold text-[#0b3019]">
                ...
                <form method="POST" action="{{ route('admin.profile.update') }}" class="mt-6 space-y-5">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="fullname" name="fullname" type="text" value="{{ old('fullname', $admin->fullname) }}" autocomplete="name" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="username" class="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400">Username</label>
                            <input id="username" name="username" type="text" value="{{ old('username', $admin->username) }}" required autocomplete="username" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="email" name="email" type="email" value="{{ old('email', $admin->email) }}" required autocomplete="email" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="phone_number" class="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400">Phone number</label>
                            <input id="phone_number" name="phone_number" type="text" value="{{ old('phone_number', $admin->phone_number) }}" autocomplete="tel" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="password" name="password" type="password" autocomplete="new-password" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        ...
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="password_confirmation" name="password_confirmation" type="password" autocomplete="new-password" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                    </div>

                    <div class="flex justify-end">
                        <button type="submit" class="inline-flex items-center gap-2 rounded-2xl bg-[#0b3019] px-5 py-2.5 text-sm font-semibold uppercase tracking-[0.2em] text-white shadow-lg shadow-[#0b3019]/25 transition hover:-translate-y-0.5 hover:bg-[#0b3019]/90">
                ...
                <form method="POST" action="{{ route('admin.profile.admins.store') }}" class="mt-6 space-y-5">
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="invite_fullname" name="fullname" type="text" value="{{ old('fullname') }}" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="invite_username" class="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400">Username</label>
                            <input id="invite_username" name="username" type="text" value="{{ old('username') }}" required class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="invite_email" name="email" type="email" value="{{ old('email') }}" required class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                        <div class="flex flex-col gap-2">
                            <label for="invite_phone" class="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400">Phone number</label>
                            <input id="invite_phone" name="phone_number" type="text" value="{{ old('phone_number') }}" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                    </div>
                    ...
                    <div class="grid gap-4 sm:grid-cols-2">
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="invite_password" name="password" type="password" required class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                        <div class="flex flex-col gap-2">
                            ...
                            <input id="invite_password_confirmation" name="password_confirmation" type="password" required class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                        </div>
                    </div>
                    ...
                    <section class="mt-8 space-y-3">
                        <header class="flex items-center justify-between">
                            <h3 class="flex items-center gap-2 text-sm font-semibold uppercase tracking-[0.25em] text-slate-400">
                                <span class="inline-flex h-7 w-7 items-center justify-center rounded-full bg-[#0b3019]/10 text-[#0b3019]">
                                    <i class="ri-team-line text-sm" aria-hidden="true"></i>
                                </span>
                                Existing admins
                            </h3>
                            <span class="rounded-full bg-[#0b3019]/10 px-3 py-1 text-xs font-semibold text-[#0b3019]">{{ $others->count() }}</span>
                        </header>
        ...
        <section class="rounded-[28px] border border-[#0b3019]/15 bg-white p-6 shadow-lg shadow-[#0b3019]/10">
            <div class="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                <div>
                    <h2 class="flex items-center gap-3 text-xl font-semibold text-[#0b3019]">
                        <span class="inline-flex h-10 w-10 items-center justify-center rounded-2xl bg-[#0b3019]/10 text-[#0b3019]">
            ...
            <form method="POST" action="{{ route('admin.profile.snapshots.store') }}" class="mt-6 grid gap-4 md:grid-cols-[1fr_200px_160px]">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input id="snapshot_notes" name="notes" type="text" value="{{ old('notes') }}" placeholder="Optional context (e.g. before deployment)" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                </div>

                <div class="flex flex-col gap-2">
                    <label for="snapshot_type" class="text-xs font-semibold uppercase tracking-[0.25em] text-slate-400">Snapshot type</label>
                    <select id="snapshot_type" name="type" class="h-11 w-full rounded-2xl border border-slate-200 bg-white px-4 text-sm text-slate-700 shadow-sm transition focus:border-[#0b3019] focus:outline-none focus:ring-2 focus:ring-[#0b3019]/30">
                            ...
                            <tbody class="divide-y divide-slate-200/70 bg-white/70">
                                @foreach ($snapshots as $snapshot)
                                    <tr class="hover:bg-emerald-50/40">
                                        ...
                                        <td class="px-4 py-3">
                                            <span class="inline-flex items-center gap-1 rounded-full bg-[#0b3019]/10 px-3 py-1 text-xs font-semibold uppercase tracking-[0.2em] text-[#0b3019]">
                                        ...
                                        <td class="px-4 py-3 text-right">
                                            <a href="{{ route('admin.profile.snapshots.download', base64_encode($snapshot['path'])) }}" class="inline-flex items-center gap-2 rounded-full border border-[#0b3019]/20 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-[0.2em] text-[#0b3019] transition hover:-translate-y-0.5 hover:bg-white/90" download>
