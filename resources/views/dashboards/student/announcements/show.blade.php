<x-layouts.dashboard :title="$title">
    ...
    <div x-data="{ loading: true }" x-init="setTimeout(() => { loading = false }, 600)" class="mx-auto w-full max-w-3xl space-y-10 px-4 py-12 sm:px-6 lg:px-8">
        <div x-show="loading" x-transition.opacity.duration.200ms class="space-y-8" role="status" aria-live="polite">
            ...
            <section class="space-y-6 rounded-[28px] border border-[#0b3019]/15 bg-white p-8 shadow-xl shadow-[#0b3019]/10">
                ...
                <div class="space-y-4">
                    <div class="skeleton h-4 w-full rounded-2xl bg-[#0b3019]/10"></div>
                    <div class="skeleton h-4 w-5/6 rounded-2xl bg-[#0b3019]/10"></div>
                </div>
                ...
                <div class="rounded-3xl border border-slate-200 bg-slate-50/70 p-6">
                    ...
                    <div class="mt-3 space-y-2">
                        ...
                        <div class="skeleton h-10 w-48 rounded-full bg-[#0b3019]/20"></div>
                    </div>
                </div>
            </section>
            ...
            <section class="space-y-4">
                ...
                <div class="space-y-3">
                    @for ($i = 0; $i < 3; $i++)
                        <article class="space-y-3 rounded-2xl border border-slate-200 bg-white p-5 shadow-md shadow-[#0b3019]/5">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <div class="skeleton h-4 w-16 rounded-full bg-[#0b3019]/20"></div>
                            </div>
                        </article>
                    @endfor
                </div>
        ...
        <div x-show="!loading" x-transition.opacity.duration.200ms x-cloak class="space-y-10">
            ...
            <article class="space-y-8 rounded-[28px] border border-[#0b3019]/15 bg-white p-8 shadow-xl shadow-[#0b3019]/10">
                ...
                <section class="space-y-4">
                    ...
                    <div class="space-y-4">
                        @foreach ($related as $item)
                            <article class="rounded-2xl border border-slate-200 bg-white p-5 shadow-md shadow-[#0b3019]/5 transition hover:-translate-y-1 hover:shadow-[#0b3019]/15">
                                ...
                                <div class="mt-3 flex items-center justify-between text-xs text-slate-400">
                                    ...
                                    <a href="{{ route('student.announcements.show', $item) }}" class="inline-flex items-center gap-2 text-sm font-semibold text-[#0b3019] transition hover:underline">
                                        Read
