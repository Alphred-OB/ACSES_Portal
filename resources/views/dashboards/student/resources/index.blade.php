<x-layouts.dashboard :title="$title">
    ...
    <div x-data="{ loading: true }" x-init="setTimeout(() => { loading = false }, 600)" class="mx-auto w-full max-w-6xl space-y-10 px-4 py-12 sm:px-6 lg:px-8">
            ...
            <section class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                @for ($i = 0; $i < 3; $i++)
                    <article class="flex h-full flex-col justify-between rounded-3xl border border-slate-200/80 bg-white p-6 shadow-lg shadow-[#0b3019]/5">
                        <div class="space-y-3">
                            <div class="skeleton h-7 w-28 rounded-full bg-[#0b3019]/10"></div>
        ...
        <div x-show="!loading" x-transition.opacity.duration.200ms x-cloak class="space-y-10">
            ...
            <form method="GET" action="{{ route('student.resources.index') }}" class="grid gap-4 rounded-3xl border border-slate-200/80 bg-white p-6 shadow-lg shadow-[#0b3019]/10 lg:grid-cols-[1fr_auto]">
            ...
            @else
                <section class="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
                    @foreach ($resources as $resource)
                        <article class="flex h-full flex-col justify-between rounded-3xl border border-slate-200/80 bg-white p-6 shadow-lg shadow-[#0b3019]/5 transition hover:-translate-y-1 hover:shadow-[#0b3019]/15">
                            <div class="space-y-3">
            ...
            <section class="rounded-3xl border border-slate-200/80 bg-white p-6 shadow-lg shadow-[#0b3019]/5">
                <h2 class="text-lg font-semibold text-[#0b3019]">Need academic assistance?</h2>
                ...
                <div class="mt-4 grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    ...
                    <div class="rounded-2xl border border-slate-200 bg-slate-50/60 p-4 text-sm text-slate-600">
                        ...
                        <p class="mt-1"><a href="mailto:acsesrepos@gmail.com" class="text-[#0b3019] hover:underline">acsesrepos@gmail.com</a></p>
